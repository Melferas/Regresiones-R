...
<p style='font-size:15px'>En la última gráfica podemos ver que los residuos se concentran más al comienzo, con los valores más bajos. Esto indica que $f3(x)$ es la función que mejor se ajusta. Los residuos y los valores obtenidos deben ser cuanto más similares posible.</p>
...
```
<p style='font-size:15px'>Como podemos observar, el coeficiente P del modelo nº2 respecto al modelo nº 1 es de **`r p1`**, mientras que del modelo nº3 al modelo nº2 es de **`r p2`**. Aunque el coeficiente es mayor en el primer caso, esto ocurre dado que la comparación ocurre en orden, lo que implica que mientras que el segundo modelo es mucho mejor que el primero, el **tercero** a su vez es incluso mejor que los dos anteriores.</p>
